...
public enum ModArmorMaterials implements ArmorMaterial {
    BAZZLE("bazzle", 26, new int[]{20,30,20,15}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 4f, 1f, () -> Ingredient.of(ModItems.BAZZLE_SHARD.get()));
    ...
    private static final int[] BASE_DURABILITY = { 20, 32, 32, 25};
    ...
    public String getName() {
        return SimpleHorrorMod.MOD_ID + ":" + this.name;
    }
